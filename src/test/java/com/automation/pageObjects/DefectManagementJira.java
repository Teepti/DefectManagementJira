...
public class DefectManagementJira {
	...
	public void getAssigneeList() throws InterruptedException, FilloException {
		...
		String strQuery="Select BugAssigned,AssigneeName from UserManagement";
	...
	public void getExcelData()throws InterruptedException {
